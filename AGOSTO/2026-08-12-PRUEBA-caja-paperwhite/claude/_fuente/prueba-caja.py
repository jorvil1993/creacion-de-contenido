...
AGOSTO = RAIZ / "AGOSTO"
CARPETA = AGOSTO / "2026-08-12-PRUEBA-caja-paperwhite" / "claude"
FUENTE = CARPETA / "_fuente"

# Aparato (ref 1) y caja real (ref 2), ambas ya derechas en contexto/referencia.
APARATO = (RAIZ / "contexto" / "referencia" / "kindle-paperwhite-16gb"
           / "frontal-negra.jpeg")
CAJA = (RAIZ / "contexto" / "referencia" / "kindle-paperwhite-16gb"
...
ESCENA = (
    "A modern black e-reader lying flat on a warm wooden desk, its matte "
    "display facing up showing a readable book page, and beside it the "
    "device's black retail packaging box standing upright with its printed "
    "cover facing the camera, soft natural window light from the left, a "
    "blurred bookshelf in the background. " + C.BLINDAJE + CAJA_BLINDAJE
)

TITULAR = 'KINDLE PAPERWHITE<br><span class="acento">CON SU CAJA</span>'
MODELO = "KINDLE PAPERWHITE"
...
def main() -> None:
    ...
    (FUENTE / "pieza.json").write_text(json.dumps({
        ...
        "producto": "kindle-paperwhite-32gb-signature",
